/***************************************************************************//**
  \file zclZslOnOffCluster.h

  \brief
    The header file describes the ZSL On/Off Cluster and its interface
...
#ifndef _ZCLZSLONOFFCLUSTER_H
#define	_ZCLZSLONOFFCLUSTER_H
...
#define ZCL_DEFINE_ONOFF_CLUSTER_COMMANDS(onCommandInd, offCommandInd, toggleCommandInd) \
    DEFINE_COMMAND(onCommand, ZCL_ONOFF_CLUSTER_ON_COMMAND_ID,  \
                     COMMAND_OPTIONS(CLIENT_TO_SERVER, ZCL_FRAME_CONTROL_DISABLE_DEFAULT_RESPONSE), \
                     onCommandInd), \
