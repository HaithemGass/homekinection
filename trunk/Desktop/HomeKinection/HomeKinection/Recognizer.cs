...
namespace HomeKinection_Speech
{
    public class Recognizer
    {
        ...
        Dictionary<string, WhatSaid> SinglePhrases = new Dictionary<string, WhatSaid>()
        {
            ...
            {"Record Gesture", new WhatSaid()   {verb=Verbs.Record}},
            {"Recording Finished", new WhatSaid()     {verb=Verbs.StopRecord}},
        };
        ...
        public void BuildGrammar(String kw)
        {
        ...
        void sre_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            if (! (0 == String.Compare((String)(semantics["Keyword"].Value),keyword)) || e.Result.Confidence < .85)
            {
