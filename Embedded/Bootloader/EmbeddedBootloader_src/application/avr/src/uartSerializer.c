...
#if defined(_USART0_) || defined(_USART1_)
...
#ifdef _KEY_REMOTE_RS232_CONTROLLER_
...
#ifdef _RCB_BB_RS232_CONTROLLER_
  #if defined(ATMEGA1281)
    DDRC = (1 << 4) | (1 << 6) | (1 << 7);
    PORTC = (1 << 6) | (1 << 7);
  #elif defined(ATMEGA128RFA1)
...
#endif // defined(_USART1_)

#endif // defined(_USART0_) || defined(_USART1_)
